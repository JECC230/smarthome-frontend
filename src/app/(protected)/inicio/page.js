...
export default function InicioPage() {
  ...
  useEffect(() => {
    async function cargarTodo() {
      try {
        ...
        // Pedimos limit=1000 para que el resumen de alertas sea real sobre todo el inventario
        ...
        setResumen({ 
          // Aquí usamos el totalItems que viene en el meta del backend
  ...
  return (
    <main className="max-w-5xl mx-auto px-6 pt-10 pb-20 font-sans">
      ...
      {/*  GRID DE TARJETAS (Diseño Apple Dark Original Restaurado) */}
